    ...
    if (this.ctx && this._paused) {
      ...
      this.ctx.resume().then(() => {
        ...
        if (this.onTick) {
          ...
          this.onTick(remaining, this.elapsed, this.totalDuration);
        }
      });
    }
  }
...
const TRACK_CATALOG = [
  { id: 'broadband-enrichment', file: 'music/broadband-enrichment.mp3', title: 'Broadband Enrichment', key: 'C', rootFreq: 261.63, bpm: 99 },
  { id: 'alpha-binaural',       file: 'music/alpha-binaural.mp3',       title: 'Alpha Binaural',       key: 'A', rootFreq: 440.00, bpm: 99 },
  { id: 'mixed-enrichment',     file: 'music/mixed-enrichment.mp3',     title: 'Mixed Enrichment',     key: 'G', rootFreq: 392.00, bpm: 99 },
  { id: 'theta-binaural',       file: 'music/theta-binaural.mp3',       title: 'Theta Binaural',       key: 'Dm', rootFreq: 293.66, bpm: null },
];
